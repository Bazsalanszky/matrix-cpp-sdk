                            ...
                            struct OperationConfig *config)
{
  ...
  *usedarg = FALSE; /* default is that we don't use the arg */
  ...
  do {
    ...
    /*
      We can't set the get type here, as this data might be used in
    ...
    case 'n':
      ...
      default:
        /* pick info from .netrc, if this is used for http, curl will
           automatically enfore user+password with the get */
        config->netrc = toggle;
        break;
      }
      break;
