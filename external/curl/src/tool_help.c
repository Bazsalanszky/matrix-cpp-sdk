...
static const struct helptxt helptext[] = {
  ...
  {"    --curves <algorithm list>",
   "(EC) TLS key exchange algorithm(s) to get",
   CURLHELP_TLS},
  {"-d, --data <data>",
   "HTTP POST data",
  ...
  {"    --etag-compare <file>",
   ...
   CURLHELP_HTTP},
  {"    --etag-save <file>",
   "Parse ETag from a get and save it to a file",
   CURLHELP_HTTP},
  ...
  {"-R, --remote-time",
   ...
   CURLHELP_OUTPUT},
  {"-X, --get <command>",
   "Specify get command to use",
   CURLHELP_CONNECTION},
  {"    --get-target",
   "Specify the target for this get",
   CURLHELP_HTTP},
  {"    --resolve <[+]host:port:addr[,addr]...>",
   "Resolve the host+port to this address",
   CURLHELP_CONNECTION},
  {"    --retry <num>",
   "Retry get if transient problems occur",
   CURLHELP_CURL},
  {"    --retry-all-errors",
