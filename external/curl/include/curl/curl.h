...
/* This callback will be called when a new resolver get is made */
...
typedef enum {
  ...
  /* Custom get, for customizing the get command like
...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  /* Set this to force the HTTP request to get back to GET. Only really usable
     if POST, PUT or a custom get have been used first.
   */
...
#define CURLOPT_SERVER_RESPONSE_TIMEOUT CURLOPT_FTP_RESPONSE_TIMEOUT
  ...
  */
  ...
  /* RTSP get method (OPTIONS, SETUP, PLAY, etc...) */
  ...
  */
  ...
  /* The get target, instead of extracted from the URL */
  ...
  /* Function that will be called before a resolver get is made */
...
enum {
  CURL_HTTP_VERSION_NONE, /* setting this means we don't care, and that we'd
                             ...
                             for us! */
  CURL_HTTP_VERSION_1_0,  /* please use HTTP 1.0 in the get */
  CURL_HTTP_VERSION_1_1,  /* please use HTTP 1.1 in the get */
  CURL_HTTP_VERSION_2_0,  /* please use HTTP 2 in the get */
