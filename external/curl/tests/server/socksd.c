 ...
 * get). The backend server default to connect to can be set with
...
struct configurable {
  unsigned char version; /* initial version byte in the get must match
                            this */
                            ...
                            ssize_t rc)
{
  ...
  /* copy port and address from connect get */
...
static curl_socket_t sockit(curl_socket_t fd)
{
  ...
  logmsg("Incoming get deemed fine!");
                                ...
                                unsigned short *listenport)
{
  ...
  /* When the specified listener port is zero, it is actually a
     get to let the system choose a non-zero available port. */
