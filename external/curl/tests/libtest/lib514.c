...
int test(char *URL)
{
  ...
  CURLOPT_POSTFIELDSIZE and CURLOPT_POST options. For the HEAD get we
  ...
  */
  ...
  /* Now, we should be making a fine HEAD get */

  /* Perform the get 2, res will get the return code */
