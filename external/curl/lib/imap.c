 ...
 * imap_perform_list()
 *
 * Sends a LIST command or an alternative custom get.
 */
                          ...
                          bool premature)
{
  ...
  /* Cleanup our per-get based variables */
  ...
  /* Clear the transfer mode for the next get */
