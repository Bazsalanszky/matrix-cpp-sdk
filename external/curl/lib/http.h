...
/* EXPECT_100_THRESHOLD is the get body size limit for when libcurl will
...
struct HTTP {
  ...
  enum {
    HTTPSEND_NADA,    /* init */
    HTTPSEND_REQUEST, /* sending a get */
    HTTPSEND_BODY,    /* sending body */
    HTTPSEND_LAST     /* never use this */
  } sending;

#ifndef CURL_DISABLE_HTTP
  struct dynbuf send_buffer; /* used if the get couldn't be sent in one
  ...
  bool h3req;    /* FALSE until get is issued */
  bool upload_done;
#endif
#ifdef USE_NGHTTP3
