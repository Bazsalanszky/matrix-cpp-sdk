...
typedef enum {
  ...
  CURLM_STATE_PROTOCONNECT, /* 7 - completing the protocol-specific connect
                                   phase */
  CURLM_STATE_DO,           /* 8 - start send off the get (part 1) */
  CURLM_STATE_DOING,        /* 9 - sending off the get (part 1) */
  CURLM_STATE_DO_MORE,      /* 10 - send off the get (part 2) */
  CURLM_STATE_DO_DONE,      /* 11 - done sending off get */
